...
<body>
    <div id="popoverContainer" class="popover-container">
        <div class="popover-card">
            ...
            <p style="color: black;">Registration  will commence on <span style="color:rgb(22, 74, 3);font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">September <sup>1</sup>, 2023</span></p>
