    ...
    <section id="schedule" class="custormBG">
        <div class="" data-aos="fade-up">
            <div class="section-header">
                <h2>LOCAL SPONSORSHIPS</h2>
            </div>
            <div class="container text-center" style="border-radius: .8rem">
                <div class="row justify-content-center">
                    <div class="col-10 ">
                        <p style="font-size: larger">
                            For Local companies and organisation wishing to target a specific day, materials or social events during the
            ...
            <div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
                ...
                <div role="tabpanel" class="col-lg-7  tab-pane show fade active" id="tanzanite">
                    <div class="row schedule-item justify-content-center ">
                        <img src="{{ asset('siteimg/sponsors/Local').'/'.$img }}" alt="{{$img}}" width="300px" height="600px">
                    </div>
                </div>
                @endforeach
