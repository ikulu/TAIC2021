...
<section id="contact" class="section-with-bg">
  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="row contact-info">
      ...
      <div class="col-lg-4" 
      style="background-color: #acdaed;border-radius: 1.2rem;text-align: center;">
      ...
      style="background-color: #acdaed;border-radius: 1.2rem;text-align: center;">
        <div class="contact-address">
          <img src="{{asset('siteimg/icons/foreigners.png')}}" width="80px" height="80px" alt="Non-Registered">
          <h3 style="padding:0px;margin:4px 0px;font-size:2.6rem;
          border-radius: .8rem;color: #001466; font-weight: 500;">
        300 USD </h3>
          <address style="font-size: 1.4rem">Foreigners</address>
        </div>
      </div>
